...
def main():
    ...
    print(f"Aadhaar Gap:                     {round(aadhaar_clean_res['confidence'] - aadhaar_blurry_res['confidence'], 4)}")
    print("--------------------------------------------------")
    ...
    print(f"Passport Gap:                    {round(passport_clean_res['confidence'] - passport_blurry_res['confidence'], 4)}")
    print("==================================================\n")
