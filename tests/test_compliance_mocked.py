...
async def test_visa_genuine():
    ...
    with patch("modules.visa.ocr.extract_visa_fields", return_value=visa_mock), \
         ...
         patch("modules.visa.binding.check_visa_passport_binding", return_value={"bound": True}), \
...
async def test_visa_tampered():
    ...
    with patch("modules.visa.ocr.extract_visa_fields", return_value=visa_mock), \
         ...
         patch("modules.visa.binding.check_visa_passport_binding", return_value={"bound": False}), \
